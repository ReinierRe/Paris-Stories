...
Listen in Dutch, English, French, or German. Choose between a male or female voice. Set your preferences once in your profile — every podcast adapts automatically.
...
All content is generated by artificial intelligence (Anthropic Claude) and converted to speech using Google Cloud Text-to-Speech. While we strive for accuracy, AI-generated content may occasionally contain inaccuracies.
```
...
ADDITIONAL FEATURES:
- Profile tab: Change language (NL/EN/FR/DE) and voice (male/female) preferences
