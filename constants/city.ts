...
const CITY_DEFAULTS: Record<string, CityConfig> = {
  ...
  london: {
    ...
    thankYouWord: "Cheers!",
    userLevels: [
      { id: "traveler", icon: "airplane-outline", minPodcasts: 0, name: { en: "Traveler", nl: "Reiziger", fr: "Voyageur", de: "Reisender", es: "Viajero" }, description: { en: "Just getting started on your London journey", nl: "Net begonnen aan je Londense reis", fr: "Vous commencez tout juste votre voyage à Londres", de: "Gerade am Anfang Ihrer London-Reise", es: "Acabas de empezar tu viaje por Londres" } },
  ...
  berlin: {
    ...
    contactEmail: "vragen@greenhome.nl",
    privacyPolicyDate: "May 12, 2026",
    localizedNames: { en: "Berlin", nl: "Berlijn", fr: "Berlin", de: "Berlin", es: "Berlín" },
    localizedCountry: { en: "Germany", nl: "Duitsland", fr: "l'Allemagne", de: "Deutschland", es: "Alemania" },
    topLevelName: { en: "City Stories", nl: "City Stories", fr: "City Stories", de: "City Stories", es: "City Stories" },
    cityHighlights: { en: "the fall of the Berlin Wall", nl: "de val van de Berlijnse Muur", fr: "la chute du Mur de Berlin", de: "den Fall der Berliner Mauer", es: "la caída del Muro de Berlín" },
    thankYouWord: "Danke!",
    userLevels: [
      { id: "traveler", icon: "airplane-outline", minPodcasts: 0, name: { en: "Traveler", nl: "Reiziger", fr: "Voyageur", de: "Reisender", es: "Viajero" }, description: { en: "Just getting started on your Berlin journey", nl: "Net begonnen aan je Berlijnse reis", fr: "Vous commencez tout juste votre voyage à Berlin", de: "Gerade am Anfang Ihrer Berlin-Reise", es: "Acabas de empezar tu viaje por Berlín" } },
      { id: "explorer", icon: "compass-outline", minPodcasts: 5, name: { en: "Explorer", nl: "Ontdekker", fr: "Explorateur", de: "Entdecker", es: "Explorador" }, description: { en: "Discovering the hidden stories of Berlin", nl: "De verborgen verhalen van Berlijn ontdekken", fr: "À la découverte des histoires cachées de Berlin", de: "Die verborgenen Geschichten von Berlin entdecken", es: "Descubriendo las historias ocultas de Berlín" } },
      { id: "connoisseur", icon: "wine-outline", minPodcasts: 15, name: { en: "Connoisseur", nl: "Kenner", fr: "Connaisseur", de: "Kenner", es: "Conocedor" }, description: { en: "A true connoisseur of Berlin life", nl: "Een echte kenner van het Berlijnse leven", fr: "Un vrai connaisseur de la vie berlinoise", de: "Ein wahrer Kenner des Berliner Lebens", es: "Un verdadero conocedor de la vida berlinesa" } },
      { id: "world-explorer", icon: "earth-outline", minPodcasts: 30, name: { en: "World Explorer", nl: "Wereldreiziger", fr: "Voyageur du Monde", de: "Weltentdecker", es: "Explorador del Mundo" }, description: { en: "A seasoned traveler with cities in your pocket", nl: "Een doorgewinterde reiziger met steden in je broekzak", fr: "Un voyageur aguerri avec les villes en poche", de: "Ein erfahrener Reisender mit Städten in der Tasche", es: "Un viajero experimentado con ciudades en el bolsillo" } },
    ],
  },
  barcelona: {
