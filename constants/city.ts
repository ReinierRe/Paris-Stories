    ...
    userLevels: [
      {
        ...
        name: { en: "Traveler", nl: "Reiziger", fr: "Voyageur", de: "Reisender", es: "Viajero" },
        description: {
          en: "Just getting started on your Barcelona journey",
          nl: "Net begonnen aan je Barcelona-reis",
          fr: "Vous commencez tout juste votre voyage à Barcelone",
          de: "Gerade am Anfang Ihrer Barcelona-Reise",
          es: "Acabas de empezar tu viaje por Barcelona",
        },
      },
      {
        id: "explorer",
        ...
        name: { en: "Explorer", nl: "Ontdekker", fr: "Explorateur", de: "Entdecker", es: "Explorador" },
        description: {
          en: "Discovering the hidden stories of Barcelona",
          nl: "De verborgen verhalen van Barcelona ontdekken",
          fr: "À la découverte des histoires cachées de Barcelone",
          de: "Die verborgenen Geschichten von Barcelona entdecken",
          es: "Descubriendo las historias ocultas de Barcelona",
        },
      },
      {
        id: "connoisseur",
        ...
        name: { en: "Connoisseur", nl: "Kenner", fr: "Connaisseur", de: "Kenner", es: "Conocedor" },
        description: {
          en: "A true connoisseur of Catalan culture",
          nl: "Een echte kenner van de Catalaanse cultuur",
          fr: "Un vrai connaisseur de la culture catalane",
          de: "Ein wahrer Kenner der katalanischen Kultur",
          es: "Un verdadero conocedor de la cultura catalana",
        },
      },
      {
        id: "barcelones",
        icon: "star-outline",
        minPodcasts: 30,
        name: { en: "Barcelonés", nl: "Barcelonees", fr: "Barcelonais", de: "Barceloneser", es: "Barcelonés" },
        description: {
          en: "You know Barcelona like a true local",
          nl: "Je kent Barcelona als een echte local",
          fr: "Vous connaissez Barcelone comme un vrai local",
          de: "Sie kennen Barcelona wie ein wahrer Einheimischer",
          es: "Conoces Barcelona como un verdadero local",
        },
      },
    ],
  },
