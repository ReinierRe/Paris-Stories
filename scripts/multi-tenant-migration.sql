...
VALUES (
  ...
  'You are a content moderator. Determine if the following podcast topic is appropriate for a general audience. The topic should be related to {city}, {country}, travel, culture, history, food, or similar subjects. Reject topics that are: sexually explicit, promoting violence or hate, about illegal activities, about weapons or drugs, or completely unrelated to {city}/{country}.\n\nTopic: "{subject}"\n\nRespond with ONLY "ALLOW" or "REJECT".',
