...
const BARCELONA_CITY = {
  ...
  userLevels: [
    ...
    { id: "barcelones", icon: "crown", minPodcasts: 30, name: { en: "Barcelonés", nl: "Barcelonees", fr: "Barcelonais", de: "Barceloneser", es: "Barcelonés" }, description: { en: "You know Barcelona like a true local", nl: "Je kent Barcelona als een echte local", fr: "Vous connaissez Barcelone comme un vrai local", de: "Du kennst Barcelona wie ein wahrer Einheimischer", es: "Conoces Barcelona como un verdadero local" } },
  ],
  roleDescription: {
